...
public interface PoiSemanticMappingMapper extends BaseMapper<PoiSemanticMappingPO> {
    ...
    @Results({
            ...
            @Result(column = "exact_typecodes", property = "exactTypecodes", typeHandler = PostgresTextArrayTypeHandler.class),
            ...
            @Result(column = "primary_category_group", property = "primaryCategoryGroup"),
            ...
            @Result(column = "meal_candidate", property = "mealCandidate"),
            @Result(column = "rest_candidate", property = "restCandidate"),
            @Result(column = "local_experience_candidate", property = "localExperienceCandidate"),
            @Result(column = "weather_sensitivity", property = "weatherSensitivity"),
            @Result(column = "mapping_version", property = "mappingVersion"),
